...
# list data we can iterate using for loop,while loop?
#print all male employees names using for loop or while loop?
...
print(type(employees))   #<class.list>
#list data we can iterate using for loop,while loop?
#print all Female employees names using for loop,while loop?
